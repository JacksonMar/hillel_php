...
/*Давайте рефакторимо код відповідно до стандартів PSR (PHP FIG). Використовуватимемо верблюжу нотацію для іменування
змінних та методів, дотримуватимемося принципу одного виразу в одному рядку та забезпечимо відстань від крайніх літералів.
P.S зробив все в 1-му файлі шоб не плодити сміття !!!
*/
<?php
class OrderService
{
